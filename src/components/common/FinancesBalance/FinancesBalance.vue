...
<template>
    <v-card class="tw-w-full tw-h-[132px] !tw-rounded-2xl !tw-p-[24px] tw-mb-6">
        <section class="tw-flex tw-justify-between tw-items-center">
            ...
            <v-btn class="!tw-rounded-xl !tw-w-[172px] !tw-h-[52px] hover:!tw-shadow-[0px_10px_18px_2px_rgba(4,182,245,0.2)]" color="#04B6F5" variant="elevated" @click="dialogOpen = true">
                ...
                <span class="tw-text-white tw-text-[16px] tw-normal-case tw-tracking-normal tw-leading-4">Пополнить</span>
            </v-btn>
        </section>
    </v-card>
